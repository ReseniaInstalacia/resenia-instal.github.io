...
const translations = {
    sl: {
        textus: "Napíšte nám",
        sendmail1: "Odoslať",
        backup: "Pošlite nám svoju správu",
        infoname: "Meno:",
        infocountry: "Krajina/Mesto:",
        infocity: "Mesto:",
        infomessage: "Telefon/posta::",
        priklad1: "Príklad prác",
        priklad2: "Príklad prác",
        priklad3: "Príklad prác",
        priklad4: "Príklad prác",
    ...
    it: {
        textus: "Scrivici",
        sendmail1: "Inviare", 
        backup: "Inviaci il tuo messaggio",
        infoname: "Nome:", 
        infocountry: "Paese/Città:", 
        infocity: "Telefono/Posta:", 
        infomessage: "Il tuo messaggio:",
        infoname: "Meno:",
        infocountry: "Krajina:",
        infocity: "Mesto:",
        infomessage: "Vaša správa:",
        priklad1: "Esempio di lavori",
        priklad2: "Esempio di lavori",
        priklad3: "Esempio di lavori",
        priklad4: "Esempio di lavori",
    ...
    en: {
        textus: "Contact",
        sendmail1: "Send",
        backup: "Send us your message",
        infoname: "Name:", 
        infocountry: "Country/City:", 
        infocity: "Phone/Post::", 
        infomessage: "Your message:",
        priklad1: "Example of works",
        priklad2: "Example of works",
        priklad3: "Example of works",
        priklad4: "Example of works",
    ...
    ru: {
        textus: "Напишите нам",
        sendmail1: "Отправить",
        backup: "Отправьте нам свое сообщение",
        infoname: "Имя:", 
        infocountry: "Страна/Город:", 
        infocity: "Телефон/почта:", 
        infomessage: "Ваше сообщение:",
        priklad1: "Пример работ",
        priklad2: "Пример работ",
        priklad3: "Пример работ",
        priklad4: "Пример работ",
    ...
    ua: {
        textus: "Напишіть нам",
        sendmail1: "Надіслати",
        backup: "Надішліть нам своє повідомлення",
        infoname: "Ім'я:", 
        infocountry: "Країна/Місто:", 
        infocity: "Телефон/пошта:", 
        infomessage: "Ваше повідомлення:",
        priklad1: "Приклад робіт",
        priklad2: "Приклад робіт",
        priklad3: "Приклад робіт",
        priklad4: "Приклад робіт",
    ...
    de: {
        textus: "Kontakt",
        sendmail1: "Senden",
        backup: "Senden Sie uns Ihre Nachricht",
        infoname: "Name:", 
        infocountry: "Land/Stadt:", 
        infocity: "Telefon/Post:", 
        infomessage: "Ihre Nachricht:",
        priklad1: "Beispiel von Arbeiten",
        priklad2: "Beispiel von Arbeiten",
        priklad3: "Beispiel von Arbeiten",
        priklad4: "Beispiel von Arbeiten",
    ...
    cz: {
        ...
        backup: "Pošlite nám svoju správu",
        infoname: "Jméno:", 
        infocountry: "Země/Město:", 
        infocity: "Telefon/pošta:", 
        infomessage: "Vaše zpráva:",
        priklad1: "Příklad prací",
        priklad2: "Příklad prací",
        priklad3: "Příklad prací",
        priklad4: "Příklad prací",
  ...
  function setLanguage(language) {
    ...
    document.getElementById('priklad1').innerText = translations[language].priklad1;
    document.getElementById('priklad2').innerText = translations[language].priklad2;
    document.getElementById('priklad3').innerText = translations[language].priklad3;
    document.getElementById('priklad4').innerText = translations[language].priklad4;
    document.getElementById('infoname').innerText = translations[language].infoname;
    document.getElementById('infocountry').innerText = translations[language].infocountry;
    document.getElementById('infocity').innerText = translations[language].infocity;
    document.getElementById('infomessage').innerText = translations[language].infomessage;
    document.getElementById('backup').innerText = translations[language].backup;
    document.getElementById('sendmail1').innerText = translations[language].sendmail1;
    document.getElementById('textus').innerText = translations[language].textus;
  }
...
const langink = document.getElementById('dropdownMenu');

// Открытие меню при нажатии на кнопку
dropdownButton.addEventListener('click', function(event) {
  event.stopPropagation(); // Останавливаем распространение события, чтобы клик не воспринимался как клик вне списка
...
document.addEventListener('click', function(event) {
  if (!dropdownMenu.contains(event.target) && event.target !== dropdownButton) {
    dropdownMenu.style.display = 'none'; // Закрыть меню, если клик был вне него
  }
});